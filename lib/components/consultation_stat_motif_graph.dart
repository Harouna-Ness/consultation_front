...
class ConsultationStatMotifGraph extends StatefulWidget {
  final Map<String, Map<String, int>> stats;
  const ConsultationStatMotifGraph({super.key, required this.stats});

  @override
  State<ConsultationStatMotifGraph> createState() =>
      _ConsultationStatMotifGraphState();
}

class _ConsultationStatMotifGraphState
    extends State<ConsultationStatMotifGraph> {
  ...
  @override
  void didUpdateWidget(covariant ConsultationStatMotifGraph oldWidget) {
